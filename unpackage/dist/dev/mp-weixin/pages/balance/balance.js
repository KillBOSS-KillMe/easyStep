...
var _balanceModel = _interopRequireDefault(__webpack_require__(/*! ./balance-model.js */ 53));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var balance = new _balanceModel.default();var _default = { data: function data() {return {};}, methods: { // 充值
    goPay: function goPay(e) {var url = "/pages/pay/pay";uni.navigateTo({ url: url });}, goWithdraw: function goWithdraw() {var url = "/pages/withdraw/withdraw";uni.navigateTo({ url: url });}, // 账户明细
    goAccountDetails: function goAccountDetails() {var url = "/pages/accountDetails/accountDetails";
      uni.navigateTo({
        url: url });
